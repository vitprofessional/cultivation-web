                        ...
                        @if($Datakey->count()>0)
                            @foreach($Datakey as $data)
                                <tr>
                                    ...
                                    <td><a data-fancybox data-type="iframe" href="{{ env('APP_URL') }}/public/upload/image/cultivation/syllabus/{{ $data->attachment }}" target="_blank"> <i class="fa fa-eye" style="color: green;"></i> </a></td>
                                </tr> 
                            @endforeach
                        @endif
                        </tbody>
