                ...
                <div class="card-body">
                    <form method="GET" class="row g-2 mb-3">
                        ...
                        <div class="col-12 col-md-3 d-flex gap-2">
                            ...
                            <a href="{{ route('newExamSchedule') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
                        </div>
                    </form>
                    ...
                    <table id="myTable" class="display border table table-hover align-middle" >
                        ...
                        @foreach($Datakey as $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('examRoutine.view', ['id' => $data->id]) }}" class="btn btn-sm btn-info me-1">View</a>
                                    <a href="{{ route('examRoutine.print', ['id' => $data->id]) }}" target="_blank" class="btn btn-sm btn-primary me-1">Print</a>
                                    <a href="{{ route('examRoutine.download', ['id' => $data->id]) }}" class="btn btn-sm btn-danger">PDF</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="routineModalLabel">Exam Routine</h5>
