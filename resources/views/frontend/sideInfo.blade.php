...
<div class="sidebar-section mb-3">
    ...
    <div class="text-center p-3">
        @php($eduImg = !empty($config->eduMinImg) ? asset('public/upload/image/cultivation/' . rawurlencode(basename($config->eduMinImg))) : asset('public/avatar.png'))
...
<div class="sidebar-section mb-3">
    ...
    <div class="text-center p-3">
        @php($bcImg = !empty($config->boardChairmanImg) ? asset('public/upload/image/cultivation/' . rawurlencode(basename($config->boardChairmanImg))) : asset('public/avatar.png'))
        ...
        <div class="sidebar-section mb-3" aria-labelledby="songHeading">
            ...
            <div class="px-3 pb-2">
                <audio controls class="w-100 sidebar-audio">
                    <source src="{{ asset('public/music/bd_national_anthem.mp3') }}" type="audio/mpeg" />
                </audio>
            </div>
        </div>
